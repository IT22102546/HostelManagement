...
export default function DashRequests() {
  ...
  const generatePDFReport = () => {
    const content = `
        ...
        <div class="details">
          <p>Total Request: ${totalRequests}</p>
          <p>Total Sales : Rs.${totalSale}.00</p>
          <p>Total Profit: Rs.${totalSale - 300 * totalRequest}.00</p>
        </div>
        <br>
        <br>
        <table>
        ...
        <div className="flex-wrap flex gap-4 justify-center">
          ...
          <div className="flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md">
            <div className="flex justify-between">
              <div className="">
                ...
                <p className="text-2xl">Rs. {totalRequests}.00</p>
              </div>
          ...
          <div className="flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md">
            <div className="flex justify-between">
              <div className="">
                ...
                <p className="text-2xl">
                  {totalRequests}.00 - 300 x {totalRequests}
                </p>
              </div>
            ...
            <div className="flex gap-2 text-sm">
              <span className="text-green-500 flex items-center">
                <HiOutlineCurrencyDollar />
                {totalRequests - deliveryfee * totalRequests}.00
              </span>
                  ...
                  <Table.Cell>
                    <div className="flex flex-row gap-2">
                      <Link to={`/update-req/${item._id}`}>
                        <button>
                          <box-icon name="edit-alt" color="#65B741"></box-icon>
                        </button>
                      </Link>
                      <button
                        onClick={() => {
