    ...
    <div className='max-w-lg mx-auto p-3 w-full' >
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        <TextInput
          ...
          defaultValue={currentUser.itnumber} onChange={handleChange}
        />
        <TextInput
          type='text'
          id='distance'
          placeholder='Distance To Campus'
          defaultValue={currentUser.distance} onChange={handleChange}
        />
        <TextInput
          type='text'
          id='acYear'
          placeholder='Accademic Year'
          defaultValue={currentUser.acYear} onChange={handleChange}
        />
        <TextInput
          type='text'
          id='mode'
          placeholder='Transport Mode'
          defaultValue={currentUser.mode} onChange={handleChange}
        />
        <TextInput
          type='text'
          id='degree'
          placeholder='Your Degree'
          defaultValue={currentUser.degree} onChange={handleChange}
        />
        <div>
