  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch('/api/rooms/add', { 
        ...
        body: JSON.stringify({ ...formData,roomtype:formData.roomtype}),
      });
    ...
    <div className="p-3 max-w-3xl mx-auto min-h-screen">
      ...
      <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
        <div className='flex flex-col gap-4 justify-between'>
          ...
          <Select onChange={(e) => setFormData({ ...formData, roomtype: e.target.value })}>
        ...
        <Button type='submit' className="bg-slate-400">Add Rooms</Button>
        {publishError && (
